...
Im_rouge = Im;
Im_rouge(:,:,1) = Im(:,:,1) .* (masque_rouge);
Im_rouge(:,:,2) = Im(:,:,2) .* (masque_rouge);
Im_rouge(:,:,3) = Im(:,:,3) .* (masque_rouge);
...
Im_vert = Im;
Im_vert(:,:,1) = Im(:,:,1) .* (masque_vert);
Im_vert(:,:,2) = Im(:,:,2) .* (masque_vert);
Im_vert(:,:,3) = Im(:,:,3) .* (masque_vert);
...
Im_bleu = Im;
Im_bleu(:,:,1) = Im(:,:,1) .* (masque_bleu);
Im_bleu(:,:,2) = Im(:,:,2) .* (masque_bleu);
Im_bleu(:,:,3) = Im(:,:,3) .* (masque_bleu);
